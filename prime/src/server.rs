...
pub(crate) struct SessionState {
    ...
    /// other output.
    pub(crate) splits: HashMap<u8, Vec<messages::CoinbaseOutput>>,
...
mod tests {
    ...
    fn a_saved_session_is_resumed_once_by_its_token() {
        ...
        assert_eq!(state.splits.get(&7), Some(&split), "the session's splits continue");
